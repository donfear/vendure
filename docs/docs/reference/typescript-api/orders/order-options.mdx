...
generated: true
---
<GenerationInfo sourceFile="packages/core/src/config/vendure-config.ts" sourceLine="710" packageName="@vendure/core" />
...
<MemberInfo kind="property" type={`<a href='/reference/typescript-api/orders/order-line-discount-distribution-strategy#orderlinediscountdistributionstrategy'>OrderLineDiscountDistributionStrategy</a>`} default={`<a href='/reference/typescript-api/orders/order-line-discount-distribution-strategy#defaultorderlinediscountdistributionstrategy'>DefaultOrderLineDiscountDistributionStrategy</a>`}  since="3.7.0"  />
