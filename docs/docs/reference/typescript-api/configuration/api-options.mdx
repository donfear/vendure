...
<MemberInfo kind="property" type={`<a href='/reference/typescript-api/configuration/api-options#subscriptionsoptions'>SubscriptionsOptions</a>`} default={`{ enabled: false }`}   />
