...
generated: true
---
<GenerationInfo sourceFile="packages/core/src/config/vendure-config.ts" sourceLine="1545" packageName="@vendure/core" />
...
<MemberInfo kind="property" type={`Required<Omit<<a href='/reference/typescript-api/configuration/api-options#apioptions'>ApiOptions</a>, 'subscriptions'>> &#38; {         subscriptions: Required<<a href='/reference/typescript-api/configuration/api-options#subscriptionsoptions'>SubscriptionsOptions</a>>;     }`}   />
