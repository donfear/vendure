...
<a name="orderupdatedtype"></a>

## OrderUpdatedType

<GraphQLDoc
  type="enum"
  typeName="OrderUpdatedType"
  typeLinks={{}}
>
{`"""The kind of change which caused an \`orderUpdated\` event to be emitted."""
enum OrderUpdatedType {
  CREATED
  UPDATED
  DELETED
  STATE_TRANSITION
...
<a name="settingsstorescopetype"></a>

## SettingsStoreScopeType

<GraphQLDoc
  type="enum"
  typeName="SettingsStoreScopeType"
  typeLinks={{}}
>
{`enum SettingsStoreScopeType {
  GLOBAL
  USER
  CHANNEL
  USER_AND_CHANNEL
